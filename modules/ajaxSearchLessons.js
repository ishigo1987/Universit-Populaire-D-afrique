module.exports = (tabPart,urlToSend,areaToInsert,themeColorText) =>
 {
    function AjaxSearchJson()
     {
         ...
         let xhrAjaxLessons = new XMLHttpRequest();
             ...
             xhrAjaxLessons.addEventListener("error", () =>
              {
                  activityIndicator.visible = false;
                  require("../custom_widgets/snackbar.js")(tabPart,50,"Pas de connexion internet","Réessayer",themeColorText, AjaxSearchJson);
   ...
   let execAjaxSearchJson = new AjaxSearchJson();
 };