exports.create = () =>
 {  
    ...
    let executeNavigationView = require("../helpers/navigationViewAnimation.js")(createnavigationView, false);
        executeNavigationView.set({drawerActionVisible:true});
    ...
    let tabFolder = new tabris.TabFolder({
       left: 0, top: 0, right: 0, bottom:0,paging: true,elevation: 2,textColor:"#fff",background:themeColor
    }).on('selectionChanged', function({value: tab})
       {
